            ...
            VStack(spacing: 0) {
                    ...
                    HStack {
                        Button(action: {
                            ...
                            HStack(spacing: 4) {
                                ...
                                Text(viewModel.currentStep == .preview ? String(localized: "Edit") : String(localized: "Back"))
                                    .font(.system(size: 16))
                            }
                        ...
                        Text(viewModel.currentStep == .preview ? String(localized: "Print Preview") : String(localized: "Text Notes"))
                            .font(.headline)
                            .fontWeight(.semibold)
                ...
                if viewModel.currentStep == .input {
                    ...
                    VStack(spacing: 30) {
                        ...
                        VStack(spacing: 12) {
                            Text(String(localized: "Create Text Notes"))
                                .font(.title2)
                                .fontWeight(.semibold)
                                .foregroundColor(.primary)
                            
                            Text(String(localized: "Write or paste text to create printable notes"))
                                .font(.body)
                        ...
                        Button(action: {
                            ...
                            Text(String(localized: "Start Writing"))
                                .font(.headline)
